import { faq } from "@/content/pr-seo-geo";
import { Section } from "./section";

// Figma frame "section-faq" (108:215), 1440×959. The frame shows every
// answer open, so they are plain text rather than a collapsible list.
    ...
    >
      <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between lg:gap-10">
        <div className="flex flex-col gap-4 lg:w-[42.1875%]">
          <p className="text-[13px] leading-[normal] font-bold text-signal uppercase">{faq.eyebrow}</p>
          <h2
            id="faq-title"
        ...
        <p className="text-[16px] leading-[1.6] text-smoke lg:w-[37.5%]">{faq.lead}</p>
      </div>
