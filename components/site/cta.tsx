...
const points = [
  "Free SEO & GEO audit of your current funnel",
  "Senior team only — no juniors, no handoffs",
      ...
      <div className="mx-auto grid max-w-[1400px] items-center gap-12 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-5 max-w-md text-pretty leading-relaxed text-mist">
            Book a free audit and we&apos;ll show you exactly where your growth
            is hiding.
          </p>
        ...
        <div className="glow-cta card-dark relative overflow-hidden rounded-3xl bg-panel p-8 sm:p-10">
          ...
          <p className="mt-2 text-sm leading-relaxed text-mist">
            A senior strategist reviews your search, AI-answer, and marketplace
            presence — and tells you what to fix first.
          </p>
          <div className="mt-7 flex flex-col gap-3">
            ...
            >
              <Link href="mailto:hello@getveliqo.com">hello@getveliqo.com</Link>
            </Button>
          </div>
